...
Current status: **M2 complete — Core v0.1 integration candidate**. Compiler baseline: **0.5.1-alpha.1**. The repository contains the normative Core surface and semantics, a working compiler pipeline, conformance evidence, and the original Megillah that motivated the project.
